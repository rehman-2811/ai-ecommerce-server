...
- [x] Propose fix: make logger create `logs/` with `recursive: true` and gracefully fall back to console when filesystem is unavailable.
- [x] Update `src/utils/logger.js` accordingly.
